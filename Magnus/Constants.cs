...
namespace Magnus
{
    class Constants
    {
        ...
        public const double MaxThinkTimePerFrame = 0.02, MaxNetCrossY = NetHeight + BallRadius * 2, SimulationNetMargin = HalfTableLength / 3, SimulationBordersMargin = BatWidth, MaxBallMaxHeight = NetHeight * 4;
